		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#vesaenvanterproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vesaenvanterproject-display": {
								"semanticObject": "vesaenvanterproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vesaenvanterproject",
									"url": sap.ui.require.toUrl("vesaenvanterproject")
								}
							}
						}
					}
