		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "proje777",
									"targetURL": "#sapui5proje2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5proje2-display": {
								"semanticObject": "sapui5proje2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5proje2",
									"url": sap.ui.require.toUrl("sapui5proje2")
								}
							}
						}
					}
